...
let WareHouseController = (() => {
    let _classDecorators = [controller('/warehouses')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _getWarehouses_decorators;
    var WareHouseController = _classThis = class {
    ...
    (() => {
        ...
        _getWarehouses_decorators = [get('/list')];
        __esDecorate(_classThis, null, _getWarehouses_decorators, { kind: "method", name: "getWarehouses", static: false, private: false, access: { has: obj => "getWarehouses" in obj, get: obj => obj.getWarehouses }, metadata: _metadata }, null, _instanceExtraInitializers);
